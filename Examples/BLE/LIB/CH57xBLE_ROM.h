...
typedef struct tag_ble_config
{
    ...
    uint8_t BufMaxLen;              // Maximum length (in octets) of the data portion of each HCI data packet( default 27 )
...
#define LIB_RAM_MAX_SIZE          0x00001000

#define RAM_BASE_ADDRESSS         0x20003800
 ...
 * @return  None
 */
#define   BB_IRQLibHandler  ((  void  (*) ( void )) BLE_LIB_JT(130) )
 ...
 * @return  None
 */
#define   LLE_IRQLibHandler ((  void  (*) ( void )) BLE_LIB_JT(131) )
 ...
 */
#define   GAPBondMgr_PeriSecurityReq  ((  bStatus_t (*) ( uint16_t connHandle ))  BLE_LIB_JT(129) )
